...
Long-read technologies show promise for improved taxonomic classifications however there is a lack of workflows for metabarcoding with ONT datasets.
We aim to explore this space and test methods that might prove useful for future metabarcoding pipelines.
...
This research project aims to fill this gap by exploring how ONT performs on mock and real world data and by producing software that may serve others working in the fungal metabarcoding space.
...
The full set of software and versions used in pipeline can be found in @apptbl-software-pipeline. 
...
See the footnotes in @apptbl-samplesheet to see which taxa were excluded from mock scenarios.
...
24 samples were collected from soil beneath four species of trees in heathy woodland from the Cranbourne Conservation area in Victoria, Australia (@apptbl-soil-samplesheet).
...
One *Allocasuarina paradoxa* (AP6) sample was excluded due to having much lower read count that other samples (@apptbl-software-soil).

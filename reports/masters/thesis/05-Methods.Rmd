...
To test the pipeline on a real world environmental sample, a set of soil samples were made available.
...
4000 reads were randomly sampled from each of the 22 soil samples and the DNA extraction control (ExCon), while 2400 reads were available from the PCR negative control (PCRNegCon).
...
For each clustering method, an OTU table and classifications table was imported into the phyloseq v1.48.0 R package [@mcmurdiePhyloseqPackageReproducible2013].

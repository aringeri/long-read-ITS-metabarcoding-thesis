...
For each of the 58 fungal isolates: 20, 50, 167, 1000, 2000 and 2500 reads were randomly selected to produce libraries with sizes of 1160, 2900, 9686, 58000, 116000 and 145000 reads (Figure \@ref(fig:equalAbundanceDiagram)).
...
```{r equalAbundanceDiagram, echo=FALSE, fig.align ='center', fig.cap = "The process for generating mock communities with equal abundance. Equal numbers of reads are selected from the set of quality filtered reads of each fungal isolate then combined into a single library. Each library is processed by the pipeline individually. "}

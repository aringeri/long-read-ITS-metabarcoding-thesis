...
Soil samples: [@tbl-soil-samplesheet]

### DNA extraction, amplification and sequencing

sequencing protocol: https://www.protocols.io/view/sequencing-fungal-metabarcode-with-pcr-primer-base-81wgbxm41lpk/v1?step=2.28 .
primers FWD + REV.

### Bioinformatics - basecalling and demultiplexing

dorado v5 sup model.
demultiplex with minibar, custom barcoding.
See @tbl-software-soil for commands.

### Sample selection

One sample AP6 excluded due to having much lower read count that other samples.
...
- min Q20 etc.
- cluster full dataset (~3 million reads) with VSEARCH
- cluster random subset of dataset (100K reads) with nanoclust
  - 4K reads per sample, except PCRNegCon -> 2400
- dnabarcoder

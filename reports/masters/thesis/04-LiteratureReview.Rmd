...
segmented into discrete events (see @fig-hmm-basecalling, [@Rang2018]). Newer basecallers such
...
data [@Stoiber2017].
<!-- TODO update based on review with Abigail -->
...
QIIME2 [@Bolyen2019].
<!-- TODO: maybe use some more up to pipelines date ones here? or remove -->

The demultiplexing tool DeepBinner [@Id2018]
...
a read [@Wick].
<!-- TODO: comment that Porechop and guppy historically used, but now dorado supports trimming -->
...
<!-- TODO: reword this for filtlong -- windowing? -->
...
- similarity scores must be determined *a priori*
- dnabarcoder
- minimap2
- kraken2
